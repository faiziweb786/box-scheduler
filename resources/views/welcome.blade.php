...
<head>
    ...
    <title>{{ config('app.name', 'Laravel') }} - Box Scheduler</title>
...
<body
    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col lg:max-w-4xl">
            ...
            <div class="text-center mb-6">
                <h1 class="text-3xl font-bold mb-4 text-[#1b1b18] dark:text-[#EDEDEC]">
                    🎯 Box Scheduler System
                </h1>
                <p class="text-lg mb-6 text-[#706f6c] dark:text-[#A1A09A]">
                    A simple system that creates boxes and doubles them every minute until reaching 16 boxes.
                </p>

                <!-- Launch Button -->
                <div class="mb-8">
                    <a href="/box-scheduler"
                        class="inline-flex items-center px-6 py-3 bg-[#1b1b18] dark:bg-[#eeeeec] text-white dark:text-[#1C1C1A] font-semibold rounded-lg shadow-lg hover:shadow-xl transition-all duration-200">
                        � Launch Box Scheduler
                    </a>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                <!-- Features Card -->
                <div
                    class="bg-white dark:bg-[#161615] rounded-lg shadow-lg p-6 border border-[#e3e3e0] dark:border-[#3E3E3A]">
                    <h3 class="text-xl font-semibold mb-4 text-[#1b1b18] dark:text-[#EDEDEC]">✨ Features</h3>
                    <ul class="space-y-2 text-[#706f6c] dark:text-[#A1A09A]">
                        <li>• Automatic box creation every minute</li>
                        <li>• Doubles from 1 → 2 → 4 → 8 → 16 boxes</li>
                        <li>• Random colors: Red, Yellow, Green, Blue, Pink, Grey</li>
                        <li>• Database storage using Eloquent ORM</li>
                ...
                <div
                    class="bg-white dark:bg-[#161615] rounded-lg shadow-lg p-6 border border-[#e3e3e0] dark:border-[#3E3E3A]">
                    <h3 class="text-xl font-semibold mb-4 text-[#1b1b18] dark:text-[#EDEDEC]">📊 Current Status</h3>
                    <div class="space-y-3">
                        <div class="flex justify-between">
                            <span class="text-[#706f6c] dark:text-[#A1A09A]">Total Boxes:</span>
                            <span class="font-bold text-[#1b1b18] dark:text-[#EDEDEC]" id="currentBoxCount">0</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-[#706f6c] dark:text-[#A1A09A]">Box Size:</span>
                            <span class="font-bold text-[#1b1b18] dark:text-[#EDEDEC]">40px × 100px</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-[#706f6c] dark:text-[#A1A09A]">Status:</span>
                            <span class="font-bold text-green-600" id="systemStatus">Ready</span>
                        </div>
                    </div>
                </div>
            </div>

            <!-- Color Array and Controls -->
            <div
                class="bg-white dark:bg-[#161615] rounded-lg shadow-lg p-6 border border-[#e3e3e0] dark:border-[#3E3E3A] mb-6">
                <h3 class="text-xl font-semibold mb-4 text-center text-[#1b1b18] dark:text-[#EDEDEC]">🎨 Color Array
                </h3>

                <!-- Color Array Display -->
                <div class="text-center mb-4">
                    <div id="colorArrayDisplay"
                        class="text-lg font-mono font-bold text-[#1b1b18] dark:text-[#EDEDEC] mb-4 p-3 bg-[#FDFDFC] dark:bg-[#0a0a0a] rounded-lg border border-[#e3e3e0] dark:border-[#3E3E3A]">
                        [red, yellow, green, blue, pink, grey]
                    </div>

                    <!-- Control Buttons -->
                    <div class="flex flex-col sm:flex-row gap-3 justify-center">
                        <button onclick="shuffleColorsWelcome()"
                            class="px-4 py-2 bg-[#1b1b18] dark:bg-[#eeeeec] text-white dark:text-[#1C1C1A] rounded-lg hover:shadow-lg transition-all duration-200">
                            🔀 Shuffle Colors
                        </button>
                        <button onclick="sortBoxesWelcome()"
                            class="px-4 py-2 bg-[#706f6c] dark:bg-[#A1A09A] text-white rounded-lg hover:shadow-lg transition-all duration-200">
                            📊 Sort Boxes
                        </button>
                    </div>
                </div>
            ...
            <div
                class="bg-white dark:bg-[#161615] rounded-lg shadow-lg p-6 border border-[#e3e3e0] dark:border-[#3E3E3A]">
                <h3 class="text-xl font-semibold mb-4 text-center text-[#1b1b18] dark:text-[#EDEDEC]">📦 Box Preview
                </h3>
                <div id="boxPreviewContainer" class="flex flex-wrap gap-3 justify-center">
                    <div class="preview-box" data-color="red"
                        style="width: 100px; height: 40px; background: #ef4444; border-radius: 6px; display: flex; align-items: center; justify-content: center; color: white; font-weight: bold; font-size: 12px; transition: all 0.3s ease;">
                        Red</div>
                    <div class="preview-box" data-color="yellow"
                        style="width: 100px; height: 40px; background: #eab308; border-radius: 6px; display: flex; align-items: center; justify-content: center; color: white; font-weight: bold; font-size: 12px; transition: all 0.3s ease;">
                        Yellow</div>
                    <div class="preview-box" data-color="green"
                        style="width: 100px; height: 40px; background: #22c55e; border-radius: 6px; display: flex; align-items: center; justify-content: center; color: white; font-weight: bold; font-size: 12px; transition: all 0.3s ease;">
                        Green</div>
                    <div class="preview-box" data-color="blue"
                        style="width: 100px; height: 40px; background: #3b82f6; border-radius: 6px; display: flex; align-items: center; justify-content: center; color: white; font-weight: bold; font-size: 12px; transition: all 0.3s ease;">
                        Blue</div>
                    <div class="preview-box" data-color="pink"
                        style="width: 100px; height: 40px; background: #ec4899; border-radius: 6px; display: flex; align-items: center; justify-content: center; color: white; font-weight: bold; font-size: 12px; transition: all 0.3s ease;">
                        Pink</div>
                    <div class="preview-box" data-color="grey"
                        style="width: 100px; height: 40px; background: #6b7280; border-radius: 6px; display: flex; align-items: center; justify-content: center; color: white; font-weight: bold; font-size: 12px; transition: all 0.3s ease;">
                        Grey</div>
                </div>
                <p class="text-center mt-4 text-[#706f6c] dark:text-[#A1A09A]">
                    Use the buttons above to shuffle colors and sort the preview boxes
                </p>
            </div>
    ...
    <script>
        // Color array for welcome page
        let welcomeColorArray = ['red', 'yellow', 'green', 'blue', 'pink', 'grey'];

        // Simple script to update current box count
        async function updateBoxCount() {
            try {
                const response = await fetch('/api/boxes');
                const data = await response.json();

                if (data.boxes) {
                    document.getElementById('currentBoxCount').textContent = data.boxes.length;

                    // Update status based on box count
                    const statusElement = document.getElementById('systemStatus');
                    if (data.boxes.length === 0) {
                        statusElement.textContent = 'Ready';
                        statusElement.className = 'font-bold text-green-600';
                    } else if (data.boxes.length < 16) {
                        statusElement.textContent = 'Running';
                        statusElement.className = 'font-bold text-blue-600';
                    } else {
                        statusElement.textContent = 'Completed';
                        statusElement.className = 'font-bold text-purple-600';
                    }
                }
            } catch (error) {
        ...
        function updateWelcomeColorArrayDisplay() {
            document.getElementById('colorArrayDisplay').textContent = '[' + welcomeColorArray.join(', ') + ']';
        }

        // Shuffle colors function for welcome page
        function shuffleColorsWelcome() {
            // Fisher-Yates shuffle algorithm
            for (let i = welcomeColorArray.length - 1; i > 0; i--) {
                const j = Math.floor(Math.random() * (i + 1));
                [welcomeColorArray[i], welcomeColorArray[j]] = [welcomeColorArray[j], welcomeColorArray[i]];
            }
            updateWelcomeColorArrayDisplay();
        }

        // Sort boxes function for welcome page
        function sortBoxesWelcome() {
            const container = document.getElementById('boxPreviewContainer');
            const boxes = Array.from(container.querySelectorAll('.preview-box'));
            ...
            boxes.sort((a, b) => {
                ...
                const indexA = welcomeColorArray.indexOf(colorA);
                const indexB = welcomeColorArray.indexOf(colorB);
                return indexA - indexB;
            });

            // Clear container and re-add sorted boxes with animation
            container.innerHTML = '';
            boxes.forEach((box, index) => {
                setTimeout(() => {
                    box.style.animation = 'fadeInScale 0.3s ease-in-out';
                    container.appendChild(box);
                }, index * 100);
            });
        }

        // Add CSS animation for welcome page
        ...
        // Update box count on page load and every 30 seconds
        document.addEventListener('DOMContentLoaded', function() {
            updateBoxCount();
            updateWelcomeColorArrayDisplay();
            setInterval(updateBoxCount, 30000);
        });
    </script>
</body>
